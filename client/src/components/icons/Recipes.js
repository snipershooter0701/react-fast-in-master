...
const Feedback = ({ fill = '#000', width = '32px', height = '32px' }) => (
    <svg
        ...
        style={{ enableBackground: 'new 0 0 28.6 28.6', fill: fill }}
    >
        <g>
            <path
                d='M24.929,24.734V1.546c0-0.85-0.697-1.546-1.547-1.546H5.217c-0.85,0-1.546,0.696-1.546,1.546v1.546v21.643v2.319
